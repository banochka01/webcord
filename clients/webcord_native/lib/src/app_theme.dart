  ...
  IconData icon(WebCordIconRole role, {bool selected = false}) {
    if (mode == AppThemeMode.telegram) {
      return switch (role) {
        ...
        WebCordIconRole.spaces => Icons.hub_outlined,
        WebCordIconRole.activity => Icons.notifications_none_rounded,
    ...
    if (mode == AppThemeMode.material) {
      return switch (role) {
        ...
        WebCordIconRole.stories => Icons.auto_stories_outlined,
        WebCordIconRole.spaces => Icons.grid_view_rounded,
        WebCordIconRole.activity => Icons.notifications_active_outlined,
    ...
    return switch (role) {
      ...
      WebCordIconRole.spaces => Icons.blur_circular_rounded,
      WebCordIconRole.activity => Icons.bolt_outlined,
      WebCordIconRole.profile => Icons.account_circle_outlined,

    ...
    return WebCordState()
      ...
      ..messages = [
        ChatMessage(
          ...
          author: alina,
          createdAt: DateTime(2026, 7, 19, 10, 15),
        ),
        ChatMessage(
          id: 2,
          channelId: 10,
          ...
          author: maria,
          createdAt: DateTime(2026, 7, 19, 10, 17),
        ),
        ChatMessage(
          id: 3,
          channelId: 10,
          ...
          author: ivan,
          createdAt: DateTime(2026, 7, 19, 10, 18),
        ),
        ChatMessage(
          id: 4,
          channelId: 10,
          ...
          createdAt: DateTime(2026, 7, 19, 10, 20),
        ),
      ];
  }

  Future<void> capture(WidgetTester tester, Size size, String golden) async {
